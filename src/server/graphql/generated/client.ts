...
/** Permet creat Activitats amb lloc y hora */
export type Activity = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfActivityDetails & {
  /** Fields of the ActivityDetails ACF Field Group */
   ...
   */
  ancestors: Maybe<ActivityToActivityConnection>;
  /** Connection between the Activity type and the category type */
  categories: Maybe<ActivityToCategoryConnection>;
  ...
  /** Whether the activity object is password protected. */
   ...
   */
  parent: Maybe<ActivityToParentConnectionEdge>;
  /** The password for the activity object. */
  ...
  /** Connection between the Activity type and the TermNode type */
  terms: Maybe<ActivityToTermNodeConnection>;
...
/** Permet creat Activitats amb lloc y hora */
export type ActivityCategoriesArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ActivityToCategoryConnectionWhereArgs>;
};


/** Permet creat Activitats amb lloc y hora */
export type ActivityContentArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};


/** Permet creat Activitats amb lloc y hora */
export type ActivityEnqueuedScriptsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** Permet creat Activitats amb lloc y hora */
export type ActivityEnqueuedStylesheetsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** Permet creat Activitats amb lloc y hora */
export type ActivityTermsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ActivityToTermNodeConnectionWhereArgs>;
};


/** Permet creat Activitats amb lloc y hora */
export type ActivityTitleArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Set relationships between the activity to categories */
export type ActivityCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes: InputMaybe<Array<InputMaybe<ActivityCategoriesNodeInput>>>;
};

/** List of categories to connect the activity to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ActivityCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the activity. If no existing category exists with this ID, no connection will be made. */
...
/** A paginated collection of activity Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of activity Nodes */
export type ActivityConnection = {
  /** A list of edges (relational context) between RootQuery and connected activity Nodes */
  edges: Array<ActivityConnectionEdge>;
  /** A list of connected activity Nodes */
  nodes: Array<Activity>;
  /** Information about pagination in a connection. */
  pageInfo: ActivityConnectionPageInfo;
};

/** Represents a connection to a activity. Contains both the activity Node and metadata about the relationship. */
export type ActivityConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected activity Node */
  node: Activity;
};

/** Pagination metadata specific to &quot;ActivityConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;ActivityConnectionEdge&quot; Nodes. */
...
/** The &quot;ActivityDetails&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ActivityDetails = AcfFieldGroup & AcfFieldGroupFields & ActivityDetails_Fields & {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ActivityDetails&quot; Field Group */
   ...
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;google_map&quot; Field Type added to the schema as part of the &quot;ActivityDetails&quot; Field Group */
  geo: Maybe<AcfGoogleMap>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ActivityDetails&quot; Field Group */
  place: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;date_time_picker&quot; Field Type added to the schema as part of the &quot;ActivityDetails&quot; Field Group (ACF Fields of the &quot;date_time_picker&quot; type return a date string according to the RFC3339 spec: https://datatracker.ietf.org/doc/html/rfc3339.) */
  startDatetime: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;ActivityDetails&quot; Field Group */
export type ActivityDetails_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ActivityDetails&quot; Field Group */
  address: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
...
/** Identifier types for retrieving a specific Activity. Specifies which unique attribute is used to find an exact Activity. */
...
/** Connection between the activity type and the activity type */
export type ActivityToActivityConnection = ActivityConnection & Connection & {
  /** Edges for the ActivityToActivityConnection connection */
  edges: Array<ActivityToActivityConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Activity>;
  /** Information about pagination in a connection. */
  pageInfo: ActivityToActivityConnectionPageInfo;
};

/** An edge in a connection */
export type ActivityToActivityConnectionEdge = ActivityConnectionEdge & Edge & {
  /**
...
/** Pagination metadata specific to &quot;ActivityToActivityConnection&quot; collections. Provides cursors and flags for navigating through sets of ActivityToActivityConnection Nodes. */
export type ActivityToActivityConnectionPageInfo = ActivityConnectionPageInfo & PageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Activity type and the category type */
export type ActivityToCategoryConnection = CategoryConnection & Connection & {
  /** Edges for the ActivityToCategoryConnection connection */
  edges: Array<ActivityToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: ActivityToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type ActivityToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Category;
...
/** Pagination metadata specific to &quot;ActivityToCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of ActivityToCategoryConnection Nodes. */
export type ActivityToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ActivityToCategoryConnection connection */
export type ActivityToCategoryConnectionWhereArgs = {
...
/** Connection between the activity type and the activity type */
export type ActivityToParentConnectionEdge = ActivityConnectionEdge & Edge & OneToOneConnection & {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /**
...
/** Connection between the activity type and the activity type */
export type ActivityToPreviewConnectionEdge = ActivityConnectionEdge & Edge & OneToOneConnection & {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Activity;
...
/** Connection between the Activity type and the TermNode type */
export type ActivityToTermNodeConnection = Connection & TermNodeConnection & {
  /** Edges for the ActivityToTermNodeConnection connection */
  edges: Array<ActivityToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: ActivityToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type ActivityToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Pagination metadata specific to &quot;ActivityToTermNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of ActivityToTermNodeConnection Nodes. */
export type ActivityToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ActivityToTermNodeConnection connection */
export type ActivityToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf: InputMaybe<Scalars['Int']['input']>;
...
export type Category = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  /** Connection between the Category type and the activity type */
  activities: Maybe<CategoryToActivityConnection>;
  ...
  /** Connection between the Category type and the projectEnergy type */
  projectsEnergy: Maybe<CategoryToProjectEnergyConnection>;
...
export type CategoryActivitiesArgs = {
  ...
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<CategoryToActivityConnectionWhereArgs>;
};
...
/** A taxonomy term that classifies content. Categories support hierarchy and can be used to create a nested structure. */
export type CategoryProjectsEnergyArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<CategoryToProjectEnergyConnectionWhereArgs>;
};
...
/** Connection between the Category type and the activity type */
export type CategoryToActivityConnection = ActivityConnection & Connection & {
  /** Edges for the CategoryToActivityConnection connection */
  edges: Array<CategoryToActivityConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Activity>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToActivityConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToActivityConnectionEdge = ActivityConnectionEdge & Edge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Activity;
...
/** Pagination metadata specific to &quot;CategoryToActivityConnection&quot; collections. Provides cursors and flags for navigating through sets of CategoryToActivityConnection Nodes. */
export type CategoryToActivityConnectionPageInfo = ActivityConnectionPageInfo & PageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToActivityConnection connection */
export type CategoryToActivityConnectionWhereArgs = {
  /** Category ID */
...
/** Connection between the Category type and the projectEnergy type */
export type CategoryToProjectEnergyConnection = Connection & ProjectEnergyConnection & {
  /** Edges for the CategoryToProjectEnergyConnection connection */
  edges: Array<CategoryToProjectEnergyConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: CategoryToProjectEnergyConnectionPageInfo;
};

/** An edge in a connection */
export type CategoryToProjectEnergyConnectionEdge = Edge & ProjectEnergyConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ProjectEnergy;
...
/** Pagination metadata specific to &quot;CategoryToProjectEnergyConnection&quot; collections. Provides cursors and flags for navigating through sets of CategoryToProjectEnergyConnection Nodes. */
export type CategoryToProjectEnergyConnectionPageInfo = PageInfo & ProjectEnergyConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToProjectEnergyConnection connection */
export type CategoryToProjectEnergyConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
export enum CommentStatusEnum {
  /** Comments with the Aprovat status */
  Approve = 'APPROVE',
  /** Comments with the Rebutjat status */
  Hold = 'HOLD',
  /** Comments with the Brossa status */
  Spam = 'SPAM',
  /** Comments with the Paperera status */
  Trash = 'TRASH'
}
...
export type CreateActivityInput = {
  /** Set connections between the activity and categories */
  categories: InputMaybe<ActivityCategoriesInput>;
...
/** Input for the createProjectEnergy mutation. */
export type CreateProjectEnergyInput = {
  /** The userId to assign as the author of the object */
  authorId: InputMaybe<Scalars['ID']['input']>;
  /** Set connections between the projectEnergy and categories */
  categories: InputMaybe<ProjectEnergyCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createProjectEnergy mutation. */
export type CreateProjectEnergyPayload = {
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  projectEnergy: Maybe<ProjectEnergy>;
};
...
/** Input for the deleteProjectEnergy mutation. */
export type DeleteProjectEnergyInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the projectEnergy to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteProjectEnergy mutation. */
export type DeleteProjectEnergyPayload = {
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId: Maybe<Scalars['ID']['output']>;
...
export type DiscussionSettings = {
  /** Permet a la gent enviar comentaris a les entrades noves. */
  defaultCommentStatus: Maybe<Scalars['String']['output']>;
  /** Permet notificacions d&#039;enllaços des d&#039;altres blogs (retropings i retroenllaços) en articles nous. */
...
export type GeneralSettings = {
  /** Un format de data per a totes les cadenes de data. */
  dateFormat: Maybe<Scalars['String']['output']>;
  /** Lema del lloc web. */
  description: Maybe<Scalars['String']['output']>;
  /** Aquesta adreça s&#039;utilitza per propòsits administratius, com ara notificacions a usuaris nous. */
  email: Maybe<Scalars['String']['output']>;
  /** Codi de la configuració regional del WordPress. */
  language: Maybe<Scalars['String']['output']>;
  /** El número del dia de la setmana en què la setmana hauria de començar. */
  startOfWeek: Maybe<Scalars['Int']['output']>;
  /** Un format d&#039;hora per a totes les cadenes de temps. */
  timeFormat: Maybe<Scalars['String']['output']>;
  /** Una ciutat en la mateixa zona horària on sou. */
...
export type MenuItemObjectUnion = Activity | Category | Page | Post | PostFormat | ProjectEnergy | Tag;
...
/** Definir projectes autoconsum compartit */
export type ProjectEnergy = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfProjectEnergyDetails & {
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors: Maybe<ProjectEnergyToProjectEnergyConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
  author: Maybe<NodeWithAuthorToUserConnectionEdge>;
  /** The database identifier of the author of the node */
  authorDatabaseId: Maybe<Scalars['Int']['output']>;
  /** The globally unique identifier of the author of the node */
  authorId: Maybe<Scalars['ID']['output']>;
  /** Connection between the ProjectEnergy type and the category type */
  categories: Maybe<ProjectEnergyToCategoryConnection>;
  /** The content of the post. */
  content: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid: Maybe<Scalars['String']['output']>;
  /** Whether the project-energy object is password protected. */
  hasPassword: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the project-energy object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent: Maybe<ProjectEnergyToParentConnectionEdge>;
  /** The password for the project-energy object. */
  password: Maybe<Scalars['String']['output']>;
  /** Connection between the projectEnergy type and the projectEnergy type */
  preview: Maybe<ProjectEnergyToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId: Maybe<Scalars['ID']['output']>;
  /** Fields of the ProjectEnergyDetails ACF Field Group */
  projectEnergyDetails: Maybe<ProjectEnergyDetails>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  projectEnergyId: Scalars['Int']['output'];
  /** If the current node is a revision, this field exposes the node this is a revision of. Returns null if the node is not a revision of another node. */
  revisionOf: Maybe<NodeWithRevisionsToContentNodeConnectionEdge>;
  /** Connection between the ProjectEnergy type and the projectEnergy type */
  revisions: Maybe<ProjectEnergyToRevisionConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status: Maybe<Scalars['String']['output']>;
  /** The template assigned to the node */
  template: Maybe<ContentTemplate>;
  /** Connection between the ProjectEnergy type and the TermNode type */
  terms: Maybe<ProjectEnergyToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title: Maybe<Scalars['String']['output']>;
  /** The unique resource identifier path */
  uri: Maybe<Scalars['String']['output']>;
...
/** Definir projectes autoconsum compartit */
export type ProjectEnergyAncestorsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** Definir projectes autoconsum compartit */
export type ProjectEnergyCategoriesArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ProjectEnergyToCategoryConnectionWhereArgs>;
};


/** Definir projectes autoconsum compartit */
export type ProjectEnergyContentArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};


/** Definir projectes autoconsum compartit */
export type ProjectEnergyEnqueuedScriptsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** Definir projectes autoconsum compartit */
export type ProjectEnergyEnqueuedStylesheetsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** Definir projectes autoconsum compartit */
export type ProjectEnergyRevisionsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ProjectEnergyToRevisionConnectionWhereArgs>;
};


/** Definir projectes autoconsum compartit */
export type ProjectEnergyTermsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ProjectEnergyToTermNodeConnectionWhereArgs>;
};


/** Definir projectes autoconsum compartit */
export type ProjectEnergyTitleArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Set relationships between the projectEnergy to categories */
export type ProjectEnergyCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes: InputMaybe<Array<InputMaybe<ProjectEnergyCategoriesNodeInput>>>;
};

/** List of categories to connect the projectEnergy to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ProjectEnergyCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description: InputMaybe<Scalars['String']['input']>;
  /** The ID of the category. If present, this will be used to connect to the projectEnergy. If no existing category exists with this ID, no connection will be made. */
  id: InputMaybe<Scalars['ID']['input']>;
  /** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name: InputMaybe<Scalars['String']['input']>;
  /** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** A paginated collection of projectEnergy Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of projectEnergy Nodes */
export type ProjectEnergyConnection = {
  /** A list of edges (relational context) between RootQuery and connected projectEnergy Nodes */
  edges: Array<ProjectEnergyConnectionEdge>;
  /** A list of connected projectEnergy Nodes */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectEnergyConnectionPageInfo;
};

/** Represents a connection to a projectEnergy. Contains both the projectEnergy Node and metadata about the relationship. */
export type ProjectEnergyConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected projectEnergy Node */
  node: ProjectEnergy;
};

/** Pagination metadata specific to &quot;ProjectEnergyConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;ProjectEnergyConnectionEdge&quot; Nodes. */
export type ProjectEnergyConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The &quot;ProjectEnergyDetails&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ProjectEnergyDetails = AcfFieldGroup & AcfFieldGroupFields & ProjectEnergyDetails_Fields & {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;google_map&quot; Field Type added to the schema as part of the &quot;ProjectEnergyDetails&quot; Field Group */
  geo: Maybe<AcfGoogleMap>;
  /** Defineix l&#039;ordre en què es visualitzarà el projecte al llistat */
  order: Maybe<Scalars['Float']['output']>;
};

/** Interface representing fields of the ACF &quot;ProjectEnergyDetails&quot; Field Group */
export type ProjectEnergyDetails_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Identifier types for retrieving a specific ProjectEnergy. Specifies which unique attribute is used to find an exact ProjectEnergy. */
export enum ProjectEnergyIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the ProjectEnergy type and the category type */
export type ProjectEnergyToCategoryConnection = CategoryConnection & Connection & {
  /** Edges for the ProjectEnergyToCategoryConnection connection */
  edges: Array<ProjectEnergyToCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Category>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectEnergyToCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type ProjectEnergyToCategoryConnectionEdge = CategoryConnectionEdge & Edge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Category;
...
/** Pagination metadata specific to &quot;ProjectEnergyToCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of ProjectEnergyToCategoryConnection Nodes. */
export type ProjectEnergyToCategoryConnectionPageInfo = CategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ProjectEnergyToCategoryConnection connection */
export type ProjectEnergyToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the projectEnergy type and the projectEnergy type */
export type ProjectEnergyToParentConnectionEdge = Edge & OneToOneConnection & ProjectEnergyConnectionEdge & {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the projectEnergy type and the projectEnergy type */
export type ProjectEnergyToPreviewConnectionEdge = Edge & OneToOneConnection & ProjectEnergyConnectionEdge & {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: ProjectEnergy;
...
/** Connection between the projectEnergy type and the projectEnergy type */
export type ProjectEnergyToProjectEnergyConnection = Connection & ProjectEnergyConnection & {
  /** Edges for the ProjectEnergyToProjectEnergyConnection connection */
  edges: Array<ProjectEnergyToProjectEnergyConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectEnergyToProjectEnergyConnectionPageInfo;
};

/** An edge in a connection */
export type ProjectEnergyToProjectEnergyConnectionEdge = Edge & ProjectEnergyConnectionEdge & {
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;ProjectEnergyToProjectEnergyConnection&quot; collections. Provides cursors and flags for navigating through sets of ProjectEnergyToProjectEnergyConnection Nodes. */
export type ProjectEnergyToProjectEnergyConnectionPageInfo = PageInfo & ProjectEnergyConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the ProjectEnergy type and the projectEnergy type */
export type ProjectEnergyToRevisionConnection = Connection & ProjectEnergyConnection & {
  /** Edges for the ProjectEnergyToRevisionConnection connection */
  edges: Array<ProjectEnergyToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectEnergyToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type ProjectEnergyToRevisionConnectionEdge = Edge & ProjectEnergyConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ProjectEnergy;
...
/** Pagination metadata specific to &quot;ProjectEnergyToRevisionConnection&quot; collections. Provides cursors and flags for navigating through sets of ProjectEnergyToRevisionConnection Nodes. */
export type ProjectEnergyToRevisionConnectionPageInfo = PageInfo & ProjectEnergyConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ProjectEnergyToRevisionConnection connection */
export type ProjectEnergyToRevisionConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the ProjectEnergy type and the TermNode type */
export type ProjectEnergyToTermNodeConnection = Connection & TermNodeConnection & {
  /** Edges for the ProjectEnergyToTermNodeConnection connection */
  edges: Array<ProjectEnergyToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectEnergyToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type ProjectEnergyToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Pagination metadata specific to &quot;ProjectEnergyToTermNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of ProjectEnergyToTermNodeConnection Nodes. */
export type ProjectEnergyToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ProjectEnergyToTermNodeConnection connection */
export type ProjectEnergyToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf: InputMaybe<Scalars['Int']['input']>;
...
export type ReadingSettings = {
  /** L&#039;identificador de la pàgina que ha de mostrar les darreres entrades */
  pageForPosts: Maybe<Scalars['Int']['output']>;
  /** L&#039;identificador de la pàgina que s&#039;ha de mostrar a la portada */
  pageOnFront: Maybe<Scalars['Int']['output']>;
  /** Quantitat d&#039;entrades del blog a mostrar. */
  postsPerPage: Maybe<Scalars['Int']['output']>;
  /** Què mostrar a la portada */
...
export type RootMutation = {
  ...
  /** The createProjectEnergy mutation */
  createProjectEnergy: Maybe<CreateProjectEnergyPayload>;
  /** The createTag mutation */
  createTag: Maybe<CreateTagPayload>;
  /** The createUser mutation */
  createUser: Maybe<CreateUserPayload>;
  /** The deleteActivity mutation */
  ...
  /** The deleteProjectEnergy mutation */
  deleteProjectEnergy: Maybe<DeleteProjectEnergyPayload>;
  ...
  /** The updateProjectEnergy mutation */
  updateProjectEnergy: Maybe<UpdateProjectEnergyPayload>;
...
/** The root mutation */
export type RootMutationCreateActivityArgs = {
...
/** The root mutation */
export type RootMutationCreateProjectEnergyArgs = {
  input: CreateProjectEnergyInput;
};
...
/** The root mutation */
export type RootMutationDeleteProjectEnergyArgs = {
  input: DeleteProjectEnergyInput;
};
...
/** The root mutation */
export type RootMutationUpdateActivityArgs = {
...
/** The root mutation */
export type RootMutationUpdateProjectEnergyArgs = {
  input: UpdateProjectEnergyInput;
};
...
export type RootQuery = {
  ...
  activities: Maybe<RootQueryToActivityConnection>;
  /** An object of the activity Type. Permet creat Activitats amb lloc y hora */
  activity: Maybe<Activity>;
  /**
   * A activity object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  activityBy: Maybe<Activity>;
  ...
  /** An object of the projectEnergy Type. Definir projectes autoconsum compartit */
  projectEnergy: Maybe<ProjectEnergy>;
  /**
   * A projectEnergy object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  projectEnergyBy: Maybe<ProjectEnergy>;
  /** Connection between the RootQuery type and the projectEnergy type */
  projectsEnergy: Maybe<RootQueryToProjectEnergyConnection>;
...
export type RootQueryActivitiesArgs = {
  ...
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<RootQueryToActivityConnectionWhereArgs>;
};
...
export type RootQueryActivityArgs = {
  ...
  id: Scalars['ID']['input'];
  idType: InputMaybe<ActivityIdType>;
};


/** The root entry point into the Graph */
export type RootQueryActivityByArgs = {
...
/** The root entry point into the Graph */
export type RootQueryProjectEnergyArgs = {
  asPreview: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType: InputMaybe<ProjectEnergyIdType>;
};


/** The root entry point into the Graph */
export type RootQueryProjectEnergyByArgs = {
  id: InputMaybe<Scalars['ID']['input']>;
  projectEnergyId: InputMaybe<Scalars['Int']['input']>;
  slug: InputMaybe<Scalars['String']['input']>;
  uri: InputMaybe<Scalars['String']['input']>;
};
...
/** The root entry point into the Graph */
export type RootQueryProjectsEnergyArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<RootQueryToProjectEnergyConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the activity type */
export type RootQueryToActivityConnection = ActivityConnection & Connection & {
  /** Edges for the RootQueryToActivityConnection connection */
  edges: Array<RootQueryToActivityConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Activity>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToActivityConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToActivityConnectionEdge = ActivityConnectionEdge & Edge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Activity;
...
/** Pagination metadata specific to &quot;RootQueryToActivityConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToActivityConnection Nodes. */
export type RootQueryToActivityConnectionPageInfo = ActivityConnectionPageInfo & PageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type RootQueryToActivityConnectionWhereArgs = {
  /** Category ID */
  categoryId: InputMaybe<Scalars['Int']['input']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the RootQuery type and the projectEnergy type */
export type RootQueryToProjectEnergyConnection = Connection & ProjectEnergyConnection & {
  /** Edges for the RootQueryToProjectEnergyConnection connection */
  edges: Array<RootQueryToProjectEnergyConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToProjectEnergyConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToProjectEnergyConnectionEdge = Edge & ProjectEnergyConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ProjectEnergy;
...
/** Pagination metadata specific to &quot;RootQueryToProjectEnergyConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToProjectEnergyConnection Nodes. */
export type RootQueryToProjectEnergyConnectionPageInfo = PageInfo & ProjectEnergyConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToProjectEnergyConnection connection */
export type RootQueryToProjectEnergyConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** The template assigned to the node */
export type Template_PginaSenseTtol = ContentTemplate & {
  /** The name of the template */
  templateName: Maybe<Scalars['String']['output']>;
};
...
/** Input for the updateProjectEnergy mutation. */
export type UpdateProjectEnergyInput = {
  /** The userId to assign as the author of the object */
  authorId: InputMaybe<Scalars['ID']['input']>;
  /** Set connections between the projectEnergy and categories */
  categories: InputMaybe<ProjectEnergyCategoriesInput>;
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date: InputMaybe<Scalars['String']['input']>;
  /** The ID of the projectEnergy object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateProjectEnergy mutation. */
export type UpdateProjectEnergyPayload = {
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  projectEnergy: Maybe<ProjectEnergy>;
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  /** Connection between the User type and the projectEnergy type */
  projectsEnergy: Maybe<UserToProjectEnergyConnection>;
...
/** A registered user account. Users can be assigned roles, author content, and have various capabilities within the site. */
export type UserProjectsEnergyArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<UserToProjectEnergyConnectionWhereArgs>;
};
...
/** Connection between the User type and the projectEnergy type */
export type UserToProjectEnergyConnection = Connection & ProjectEnergyConnection & {
  /** Edges for the UserToProjectEnergyConnection connection */
  edges: Array<UserToProjectEnergyConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ProjectEnergy>;
  /** Information about pagination in a connection. */
  pageInfo: UserToProjectEnergyConnectionPageInfo;
};

/** An edge in a connection */
export type UserToProjectEnergyConnectionEdge = Edge & ProjectEnergyConnectionEdge & {
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ProjectEnergy;
...
/** Pagination metadata specific to &quot;UserToProjectEnergyConnection&quot; collections. Provides cursors and flags for navigating through sets of UserToProjectEnergyConnection Nodes. */
export type UserToProjectEnergyConnectionPageInfo = PageInfo & ProjectEnergyConnectionPageInfo & WpPageInfo & {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the UserToProjectEnergyConnection connection */
export type UserToProjectEnergyConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Provides access to fields of the &quot;ActivityDetails&quot; ACF Field Group via the &quot;activityDetails&quot; field */
export type WithAcfActivityDetails = {
  /** Fields of the ActivityDetails ACF Field Group */
  activityDetails: Maybe<ActivityDetails>;
};

/** Provides access to fields of the &quot;ProjectEnergyDetails&quot; ACF Field Group via the &quot;projectEnergyDetails&quot; field */
export type WithAcfProjectEnergyDetails = {
  /** Fields of the ProjectEnergyDetails ACF Field Group */
  projectEnergyDetails: Maybe<ProjectEnergyDetails>;
};
...
export type GetActivitiesQuery = { activities: { nodes: Array<{ id: string, status: string, title: string, slug: string, featuredImageId: string, dateGmt: string, contentTypeName: string, modifiedGmt: string, content: string, featuredImage: { node: { altText: string, id: string, fileSize: number, dateGmt: string, mediaItemUrl: string, mediaType: string, mimeType: string, modifiedGmt: string, slug: string, sourceUrl: string, mediaDetails: { width: number, height: number, file: string } } }, activityDetails: { address: string, place: string, startDatetime: string, geo: { latitude: number, longitude: number, streetAddress: string } }, categories: { nodes: Array<{ name: string, id: string }> } }> } };

export type GetProjectsEnergyQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProjectsEnergyQuery = { projectsEnergy: { nodes: Array<{ content: string, dateGmt: string, featuredImageId: string, id: string, modifiedGmt: string, title: string, slug: string, status: string, projectEnergyDetails: { order: number, geo: { latitude: number, longitude: number, streetAddress: string } }, featuredImage: { node: { altText: string, dateGmt: string, id: string, mediaType: string, mimeType: string, modifiedGmt: string, slug: string, sourceUrl: string, fileSize: number, mediaDetails: { height: number, width: number, file: string } } } }> } };
...
export const GetProjectsEnergyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getProjectsEnergy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectsEnergy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"dateGmt"}},{"kind":"Field","name":{"kind":"Name","value":"featuredImageId"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"modifiedGmt"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"projectEnergyDetails"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"order"}},{"kind":"Field","name":{"kind":"Name","value":"geo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"streetAddress"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"featuredImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"altText"}},{"kind":"Field","name":{"kind":"Name","value":"dateGmt"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"mediaType"}},{"kind":"Field","name":{"kind":"Name","value":"mimeType"}},{"kind":"Field","name":{"kind":"Name","value":"modifiedGmt"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"sourceUrl"}},{"kind":"Field","name":{"kind":"Name","value":"fileSize"}},{"kind":"Field","name":{"kind":"Name","value":"mediaDetails"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"height"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"file"}}]}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getProjectsEnergy(variables?: GetProjectsEnergyQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetProjectsEnergyQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProjectsEnergyQuery>({ document: GetProjectsEnergyDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'getProjectsEnergy', 'query', variables);
    }
  };
}
